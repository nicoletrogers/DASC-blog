...
combination_without_outliers4ggplot(combination_without_outliers4, aes(x = `Arable land needed to produce a fixed quantity of crops ((1.0 = 1961))`, y = gdpPercap, color = continent)) +
  geom_point() +
  geom_smooth(method = "lm") +
